<div id="tidio-wrapper">
    ...
    <div id="tidio-chat-wp-plugin">
        ...
        <div id="welcome-text">
            <h1>Hello, It's great that you have installed Tidio Chat.</h1>
            <p>To complete integration with Tidio Chat, please select from the options below. If you have an account with us already, then the current project will be assigned to that account, If you do not have an account with us or would like to create a new one, please select the option on the right.</p>
        </div>
        <div id="after-install-text">
            <h1>Your site is already integrated with Tidio Chat</h1>
            <p>Now you just need to select the "Tidio Chat" tab on the left to go to your panel, or you can open the chat panel by  clicking the link below.</p>
